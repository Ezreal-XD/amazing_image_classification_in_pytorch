...
def parse_args():
    ...
    parser.add_argument('--model', default="shapenet15_bn_gap", help="model name: (default shapenet15_bn_gap)")
    parser.add_argument('--dataset', default="hansim", help="dataset: cityscapes or hansim")
